...
export namespace ConfigKey {
	...
	*/
	...
	export const CustomProviders = defineSetting<Record<string, { name: string; baseUrl: string; apiFormat: 'openai-chat' | 'openai-responses' | 'gemini' | 'claude' }>>('chat.customProviders', ConfigType.Simple, {});
