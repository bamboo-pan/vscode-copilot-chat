...
import { CustomPromptComponents, DefaultAgentPromptProps, detectToolCapabilities } from '../defaultAgentInstructions';
...
class Gpt51CodexPrompt extends PromptElement<DefaultAgentPromptProps> {
	...
	async render(state: void, sizing: PromptSizing) {
		...
		return <InstructionMessage>
			{showCoreInstructions && <Tag name='editing_constraints'>
			...
			{showCoreInstructions && <Tag name='exploration_and_reading_files'>
			...
			{showCoreInstructions && <Tag name='additional_notes'>
			...
			{showToolUseInstructions && <Tag name='tool_use'>
			...
			{showCoreInstructions && <Tag name='handling_errors_and_unexpected_outputs'>
			...
			{showCoreInstructions && <Tag name='special_user_requests'>
			...
			{showCoreInstructions && <Tag name='frontend_tasks'>
			...
			{showOutputFormatting && <Tag name='presenting_your_work_and_final_message'>
			...
			{showOutputFormatting && <Tag name='final_answer_structure_and_style_guidelines'>
			...
			{showOutputFormatting && <Tag name='special_formatting'>
